export const omniModelFactoryAbi = [
    {
        ...
        inputs: [{ name: '_gaugeVoter', type: 'address', internalType: 'contract IAddressGaugeVoter' }],
        outputs: [{ name: 'result', type: 'address', internalType: 'contract AddressGaugeRatioModel' }],
        stateMutability: 'nonpayable',
    },
    {
        type: 'function',
        name: 'deployTokenGaugeRatioModel',
        inputs: [{ name: '_gaugeVoter', type: 'address', internalType: 'contract ITokenGaugeVoter' }],
        outputs: [{ name: 'result', type: 'address', internalType: 'contract TokenGaugeRatioModel' }],
        stateMutability: 'nonpayable',
    },
    {
        type: 'event',
