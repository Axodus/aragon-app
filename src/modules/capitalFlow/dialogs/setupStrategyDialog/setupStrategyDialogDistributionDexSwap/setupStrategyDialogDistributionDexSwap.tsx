...
export const SetupStrategyDialogDistributionDexSwap: React.FC<ISetupStrategyDialogDistributionDexSwapProps> = () => {
    ...
    const cowSwapSettlementAddressField = useFormField<
        ISetupStrategyForm,
    ...
    return (
        <div className="flex w-full flex-col gap-6">
            ...
            <InputText
                ...
                placeholder={t(
                    'app.capitalFlow.setupStrategyDialog.distributionDexSwap.targetTokenAddress.placeholder',
                )}
            ...
            <InputText
                helpText={t(
                    'app.capitalFlow.setupStrategyDialog.distributionDexSwap.cowSwapSettlementAddress.helpText',
                )}
                placeholder={t(
                    'app.capitalFlow.setupStrategyDialog.distributionDexSwap.cowSwapSettlementAddress.placeholder',
                )}
