...
export interface INetworkDefinitionAddresses {
    ...
    globalExecutor: Hex;
    /**
     * Address of the condition factory.
     */
...
export const networkDefinitions: Record<Network, INetworkDefinition> = {
    ...
    [Network.AVAX_MAINNET]: {
        ...
        addresses: {
            ...
            pluginSetupProcessor: '0x95902780BD390A32f2E1EDf02623F8e636CEE518',
    ...
    [Network.HARMONY_MAINNET]: {
        ...
        harmonyPlugins: {
            hipVotingPluginRepo: '0x377Fa6d56066b81a7233043302B7e1569591253E',
            delegationVotingPluginRepo: '0x908a794F6e59872cB9b5Da0465a667833eEBdcFD',
            validatorOptInRegistry: '0x1E1F6128f1e611c6bD9696a758aF9310017C993B',
            hipPluginAllowlist: '0x3653c14Ca7bef3E7B02ca04E65f6fc174D48c5C0',
        },
    },
