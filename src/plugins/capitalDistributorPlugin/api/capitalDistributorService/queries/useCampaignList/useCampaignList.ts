...
export const campaignListOptions = (
    ...
    options?: InfiniteQueryOptions<IPaginatedResponse<ICampaign>, IGetCampaignListParams>,
): SharedInfiniteQueryOptions<IPaginatedResponse<ICampaign>, IGetCampaignListParams> => ({
    queryKey: capitalDistributorServiceKeys.campaigns(params),
    initialPageParam: params,
    queryFn: ({ pageParam }) => capitalDistributorService.getCampaignList(pageParam),
